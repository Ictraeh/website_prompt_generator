...
const stackProfiles = [
  {
    id: "vite_default",
    label: "默认：Vite + React18 + TS + Tailwind3 + lucide",
    optionalLines: [],
  },
  {
    id: "next_optional",
    label: "扩展：Next.js 14 App Router（替代 Vite 路由壳）",
    optionalLines: [
  ...
  {
    id: "gsap_scroll",
    label: "扩展：GSAP 时间线 / ScrollTrigger（scrub、pin）",
    optionalLines: [
...
const platforms = [
  { id: "web_marketing_landing", label: "营销落地页（多区块）", labelEn: "Marketing landing (multi-section)", defaultSections: 5, stackNote: "React + TypeScript + Vite + Tailwind + lucide-react; optional motion" },
  { id: "web_hero_single", label: "单屏 Hero（首屏叙事）", labelEn: "Single-viewport hero", defaultSections: 1, stackNote: "React + TypeScript + Vite + Tailwind" },
  { id: "web_app_product", label: "Web 应用（产品界面）", labelEn: "Product web app shell", defaultSections: 4, stackNote: "React + TypeScript + Vite + Tailwind; optional shadcn/ui" },
  { id: "web_app_dashboard", label: "Web 应用（数据看板）", labelEn: "Dashboard web app", defaultSections: 6, stackNote: "React + TypeScript + Vite + Tailwind + dense tables/charts placeholders" },
];
...
const colorVibeGroups = [
  { id: "brand_intersection", label: "品牌多色「交集」— 几色互相牵制仍整体协调（Huemint Brand）" },
  { id: "website_magazine", label: "杂志式网页 — 约四色分工、像版面分栏（Huemint Website · Magazine）" },
  { id: "website_monochrome", label: "单色阶网页 — 大量留白 + 中间灰做层次（Huemint Website · Monochrome）" },
  { id: "gradient_bridge", label: "小跨度渐变 / 暗底光晕 — 色相变化窄、易做成套 Token" },
  { id: "classic_vibes", label: "经典气质 — 深色 / 霓虹 / 大地 / 波普等（原有）" },
];
...
const motionKits = [
  ...
  },
  {
    id: "M-char-cascade",
    group: "site",
    label: "标题逐字出现 — 适合大标题抢注意力",
    detail: "30ms/字; 200ms 起延迟; opacity + translateX on inline-block spans",
  },
  {
    id: "M-delay-fade",
    group: "site",
    label: "延迟淡入 — 慢半拍再显现，更克制",
  ...
  },
  {
    ...
    label: "动画类 — 光标、粒子、点击火花、GSAP 等",
    detail:
      "React Bits / Animations: 在页面下方「动效代码」里选具体 TSX；可与整站 M-kit 叠加，注意 §3.2 性能与 reduced-motion",
  },
  {
    id: "RB-Backgrounds",
    group: "reactbits",
    rbCategory: "Backgrounds",
    label: "背景类 — 渐变、网格、极光、动态底",
    detail:
      "React Bits / Backgrounds: 作 hero 或区块底纹；注意层级 z-index 与正文对比度",
  },
  {
    id: "RB-Components",
    group: "reactbits",
    rbCategory: "Components",
    label: "组件类 — 轮播、折叠、卡片等整块 UI",
    detail: "React Bits / Components: 可复用区块级组件；按需裁剪 props",
  },
  {
    id: "RB-TextAnimations",
    group: "reactbits",
    rbCategory: "TextAnimations",
    label: "文字动画类 — 渐变字、拆分标题、滚动字效",
    detail: "React Bits / TextAnimations: 标题与标语层次；避免整页滥用",
  },
];
