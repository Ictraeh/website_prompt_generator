# Fire Ocean Color System (AI-Ready Foundation)

This file organizes the Fire Ocean palette into a complete design + development token system for landing pages, brand pages, and product UI usage.

## Source Notes
- Fire Ocean palette used: `#8ECAE6 #219EBC #023047 #FFB703 #FB8500`.
- Mapping: primary `#219EBC`, secondary `#023047`, accents `#FFB703/#FB8500`, support `#8ECAE6`.
